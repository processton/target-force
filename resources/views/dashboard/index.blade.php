            ...
            <div class="card">
                ...
                <div class="card-table table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                        @forelse($completedPosts as $post)
                            <tr>
                                <td>
                                    @if ($post->draft)
                                ...
                                <td>{{ number_format($postStats[$post->id]['ratios']['click'] * 100, 1) . '%' }}</td>
                        ...
                        @empty
                            <tr>
                                <td colspan="100%">
                                    <p class="empty-table-text">{{ __('You have not completed any posts.') }}</p>
                                </td>
                            </tr>
                        @endforelse
                        </tbody>
                    ...
                    <table class="table">
                        ...
                        @forelse($recentSubscribers as $subscriber)
                            <tr>
                                ...
                                <td><a href="{{ route('targetforce.subscribers.edit', $subscriber->id) }}"
...
@push('js')
    <script src="{{ asset('vendor/targetforce/js/Chart.bundle.min.js') }}"></script>
