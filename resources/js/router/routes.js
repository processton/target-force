...
export default [
  ...
  },
  {
    ...
    children: [
      { path: "", redirect: { name: "forms.show" } },
      {
        path: "submissions",
        name: "forms.show",
        component: page("forms/show/submissions.vue"),
      },
      {
        path: "share",
        name: "forms.show.share",
        component: page("forms/show/share.vue"),
      },
      {
        path: "analytics",
        name: "forms.show.analytics",
        component: page("forms/show/stats.vue"),
      },
    ],
  },
  ...
  //   path: "/privacy-policy",
  //   name: "privacy-policy",
  //   component: page("legal-help/privacy-policy.vue"),
  // },
  // {
  //   path: "/terms-conditions",
  //   name: "terms-conditions",
  //   component: page("legal-help/terms-conditions.vue"),
  // },

  // Community
  // {
  //   path: "/discount-students-academics-ngos",
  //   name: "discount-community",
  //   component: page("community/students-academics-ngos.vue"),
  // },
  ...
  //   name: "aiformbuilder",
  //   component: page("ai-form-builder.vue"),
  // },
  // {
  //   path: "/integrations",
  //   name: "integrations",
  ...
  {
    path: "/forms/:slug",
    name: "forms.show_public",
    component: page("forms/show-public.vue"),
  },
  ...
  //   path: "/my-templates",
  //   name: "my_templates",
  //   component: page("templates/my_templates.vue"),
  // },
  // {
  //   path: "/form-templates",
  //   name: "templates",
  //   component: page("templates/templates.vue"),
  // },
  // {
  //   path: "/form-templates/:slug",
  //   name: "templates.show",
  //   component: page("templates/show.vue"),
  // },
  // {
  //   path: "/form-templates/types/:slug",
  //   name: "templates.types.show",
  //   component: page("templates/types-show.vue"),
  // },
  // {
  //   path: "/form-templates/industries/:slug",
  //   name: "templates.industries.show",
