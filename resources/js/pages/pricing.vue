          ...
          <div class="flex items-start gap-4">
            ...
            <div>
              ...
              <p class="mt-1 text-base font-medium leading-7 text-yellow-600">
                Whether your nonprofit is large or small, ’s online Form Builder helps your organization help
    ...
    <section class="py-12 bg-gray-50 border-t border-gray-200 sm:py-16 lg:py-20 xl:py-24">
      <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        ...
        <dl
          ...
          <div v-for="q in [
            {
              'question':'Is there a free version of  available?',
              'answer':'Yes,  offers a free version with access to 99% of features, including unlimited forms, submissions, fields, and more. Our goal is to provide robust functionality for all users without limitations.',
            },
            {
              'question':'What does the Pro Plan include?',
              'answer':'The  Pro Plan is designed to meet the advanced needs of teams and creators. It includes features like form confirmation emails, Slack and Discord notifications, editable submissions, custom domain, custom code integration, larger file uploads, removal of  branding, priority support, and more.',
            },
            {
              'question':'Can I try the Pro Plan before subscribing?',
              'answer':'Absolutely! We offer a free 3-day trial of the  Pro Plan. This allows you to explore all the empowering features and experience the value it brings to your form-building process. The trial is automatically applied.',
            },
            {
            ...
            },
            {
              ...
              'answer':' is committed to supporting nonprofits and students. We provide an exclusive 50% discount on the Pro Plan for nonprofit organizations and students. This discount helps you make the most of our form builder while staying within your budget.',
            },
            {
              'question':'Can I cancel or change my plan at any time?',
              'answer':'Yes, you have the flexibility to upgrade, downgrade, or cancel your  Pro Plan at any time. Changes will take effect immediately, and you\'ll only be billed based on the plan you\'re currently on.',
            },
          ]" :key="q.question">
...
export default {
  ...
  data: () => ({
    metaTitle: 'Pricing',
    metaDescription: 'All of our core features are free, and there is no quantity limit. You can also created more advanced and customized forms with s Pro.',
  }),
