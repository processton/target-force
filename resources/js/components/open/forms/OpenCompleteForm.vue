    ...
    >
      <div v-if="!submitted" key="form">
        ...
        <p v-if="!form.no_branding" class="text-center w-full mt-2">
          <a href="https://opnform.com?utm_source=form&utm_content=powered_by"
             ...
             target="_blank"
          >Powered by <span class="font-semibold"></span></a>
        </p>
      </div>
      <div v-else key="submitted" class="px-2">
        ...
        <p v-if="!form.no_branding" class="mt-5">
          <a target="_parent" href="https://opnform.com/?utm_source=form&utm_content=create_form_free" class="text-nt-blue hover:underline">Create your form for free with </a>
        </p>
      </div>
    </transition>
  </div>
